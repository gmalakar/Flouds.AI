# =============================================================================
# File: export_and_optimize_v2.py
# Date: 2025-06-10
...
def export_and_optimize_onnx_v2(
    model_name: str,
    model_for: str = "fe",
    optimize: bool = False,
    ...
    if model_for not in [
        ...
        raise ValueError(
            f"Invalid model_for: {model_for}. Must be one of: fe, s2s, sc, llm"
        )
    ...
    def _export_model_to_onnx(
        ...
        try:
            if model_for == "s2s" or model_for == "seq2seq-lm":
                ...
                print(f"Attempting to load as causal LM model...")
            ...
            if "Unrecognized configuration class" in str(e):
                ...
                if model_type in ["llama", "mistral", "qwen", "phi", "gemma"]:
                    print("   - Try using --model_for 'llm' for causal language models")
                    print("   - Or try --model_for 'fe' for feature extraction")
                    print(
