...
def get_model_file_paths(model_path: str, model_config: OnnxConfig) -> tuple[str, str]:
    ...
    encoder_path = validate_safe_path(os.path.join(model_path, encoder_filename), root_path)
    decoder_path = validate_safe_path(os.path.join(model_path, decoder_filename), root_path)
