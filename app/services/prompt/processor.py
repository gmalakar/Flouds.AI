...
class PromptProcessor(BaseNLPService):
    ...
    def _process_prompt_local(request: PromptRequest) -> SummaryResults:
        ...
        try:
            ...
            if use_seq2seqlm:
                ...
                return run_encoder_only_generation(
                ...
                encoder_path, decoder_path = get_model_file_paths(
    ...
    def _get_encoder_session(encoder_model_path: str) -> Optional[Any]:
        ...
        try:
            ...
            logger.debug(
                "Creating encoder session with provider %s", sanitize_for_log(provider)
            )
...
def get_special_tokens_path(model_path: str, model_config: Any) -> str:
    ...
    special_tokens_file = getattr(
        model_config, "special_tokens_file", "special_tokens.json"
    )
