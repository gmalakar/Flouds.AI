# =============================================================================
# File: test_request_middlewares_flouds.py
# Date: 2026-01-30
...
# =============================================================================
# File: test_request_middlewares_flouds.py
# Mirrored middleware tests (from Flouds.Py canonical cases)
# =============================================================================
...
# Shim `app.app_init` so middleware initializers that import APP_SETTINGS
# during import-time will see a test-controlled object.
shim: Any = types.ModuleType("app.app_init")
...
def test_request_size_limit_middleware_rejects_by_content_length():
    ...
    # Configure via APP_SETTINGS shim; do not pass `max_size` kwarg to keep test independent of ctor signature
